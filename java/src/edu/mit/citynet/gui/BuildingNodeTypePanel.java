...
public class BuildingNodeTypePanel extends BuildingPanel implements ListSelectionListener
{
    ...
    private class NodeTypeTableModel extends AbstractTableModel {
		...
		public void setTypes(City city) {
			...
			for(CitySystem system : city.getSystems()) {
				nodeTypes.addAll(system.getNodeTypes());
			}
		 ...
		 */
		public NodeType getSelectedNodeRegion() {
			return selected;
		}
		...
		public NodeType getElement(int index)
		{
    ...
    private class AttributeTableModel extends AbstractTableModel {
		private static final long serialVersionUID = 5386287393549485163L;
		private List<NodeTypeAttribute> nodeAttributes;
		private NodeTypeAttribute selected;
		private String headers[];
		...
		public AttributeTableModel(String cols[]) {
			super();
			nodeAttributes = new ArrayList<NodeTypeAttribute>();
			headers  = cols;			
		}
		 ...
		 * @param city the new node regions
		 */
		public void setAttributes(NodeType nt) {
		 ...
		 * @return the selected node region
		 */
		public NodeTypeAttribute getSelectedNodeRegion() {
			return selected;
		}
		...
		public NodeTypeAttribute getElement(int index)
		{
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		NodeType nt = typesmodel.getElement(index);
		attributesmodel.setAttributes(nt);
